        ...
        Data.once('value', rates => {
            if (rates.val()) {
                ...
                for (var i = 0; i < carTypeWiseRate.car_type.length; i++) {
                    if (carTypeWiseRate.car_type[i].name == carType && carTypeWiseRate.car_type[i].category =='Car') {
    ...
    async getDirections(startLoc, destLoc) {
        try {
            ...
            this.setState({
                ...
                distancemain: fareCalculation.minKM,
                minFare: fareCalculation.minFare,
                        ...
                        <View style={styles.modalInner}>
                            ...
                            <View style={styles.upperContainer}>
                                <View style={styles.fareDetailsContainer}>
                                    ...
                                    <Text style={styles.fareTitleText}>Min Fare/{this.state.minKM}</Text>    
                                    <Text style={styles.fareTitleText}>Rate/KM</Text>
                                    ...
                                    <View style={styles.farePriceContainer}>
                                        <Text style={styles.farePriceText}>{Currency} {this.state.minFare} </Text>
